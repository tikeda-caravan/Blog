...
２つの正規母集団の無作為標本（標本の大きさはそれぞれ $n_A, n_B$ ）から求められる不偏分散をそれぞれ $U_A^2, U_B^2$ とし，これらが独立であるものとします。２群の母分散が等しいという帰無仮説のもとで，次の検定統計量を答えろ。<u>またその時の自由度も答えろ</u>
